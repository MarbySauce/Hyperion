...
class DetachmentWavelength {
	constructor() {
		let this_instance = this; // Need to do this so LaserMode methods can get access to DetachmentWavelength class methods

		this.standard = new LaserMode(this_instance, this.MODE.STANDARD);
		this.doubled = new LaserMode(this_instance, this.MODE.DOUBLED);
		this.raman = new LaserMode(this_instance, this.MODE.RAMAN);
		this.irdfg = new LaserMode(this_instance, this.MODE.IRDFG);
	}
	...
	convert(laser_mode) {
		switch (laser_mode.mode) {
			case this.MODE.STANDARD:
				DetachmentWavelength_convert_standard(this, laser_mode);
				break;
			case this.MODE.DOUBLED:
				DetachmentWavelength_convert_doubled(this, laser_mode);
				break;
			case this.MODE.RAMAN:
				DetachmentWavelength_convert_raman(this, laser_mode);
				break;
			case this.MODE.IRDFG:
				DetachmentWavelength_convert_irdfg(this, laser_mode);
				break;
		}
	}
}
...
class ExcitationWavelength {
	constructor() {
		let this_instance = this; // Need to do this so LaserMode methods can get access to ExcitationWavelength class methods

		this.nIR = new LaserMode(this_instance, this.MODE.NIR);
		this.iIR = new LaserMode(this_instance, this.MODE.IIR);
		this.mIR = new LaserMode(this_instance, this.MODE.MIR);
		this.fIR = new LaserMode(this_instance, this.MODE.FIR);
	}
	...
	convert(laser_mode) {
		switch (laser_mode.mode) {
			case this.MODE.NIR:
				ExcitationWavelength_convert_nir(this, laser_mode);
				break;
			case this.MODE.IIR:
				ExcitationWavelength_convert_iir(this, laser_mode);
				break;
			case this.MODE.MIR:
				ExcitationWavelength_convert_mir(this, laser_mode);
				break;
			case this.MODE.FIR:
				ExcitationWavelength_convert_fir(this, laser_mode);
				break;
		}
	}
}
